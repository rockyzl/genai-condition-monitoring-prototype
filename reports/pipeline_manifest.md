...
- Seed: **42**  ·  dataset: **FD001**  ·  RUL cap: **125**  ·  git: `a61b8c4`
- Journal: `/tmp/pytest-of-lu2/pytest-30/test_run_stage_then_skip_secon0/journal.jsonl` (append-only NDJSON, one line per step event)
